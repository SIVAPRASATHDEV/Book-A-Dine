<x-guest-layout>
    <div class="container mt-5">
        <nav class="breadcrumb ">
            ...
            <span class="breadcrumb-item breadcrumb-item-active" aria-current="page">Reservation</span> 
            <span class="breadcrumb-item breadcrumb-item-active" aria-current="page">Step 1</span>
        </nav>
    </div>
    <div class="container w-full px-5 py-6 mx-auto">
        <div class="flex items-center min-h-screen bg-black-50">
