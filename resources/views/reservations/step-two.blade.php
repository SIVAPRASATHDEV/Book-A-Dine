<x-guest-layout>
    <div class="container mt-5">
        <nav class="breadcrumb ">
            ...
            <a class="breadcrumb-item" href="{{ route('reservations.step.one')}}">Reservation</a> 
            <a class="breadcrumb-item" href="{{ route('reservations.step.one')}}">Step 1</a> 
            <span class="breadcrumb-item breadcrumb-item-active" aria-current="page">Step 2</span> 
        </nav>
    </div>
